...
public class RechargeRecordServiceImpl implements RechargeRecordService{
	...
	public int countAll(Integer acountId) {
		int c = rechargeRecordDao.countAll(acountId);
		return c;
	}

	@Override
	public List<RechargeRecord> browsePagingRechargeRecord(Integer acountId,int pageNum, int pageSize,
		...
		List<RechargeRecord> l = rechargeRecordDao.browsePagingRechargeRecord( acountId,pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
