...
public interface CatchRecordService {
	...
	/** 分页抓取记录信息 */
	public List<CatchRecord> browsePagingCatchRecord(Integer goodsId,Integer acountId,Integer status,int pageNum,int pageSize,String orderName,String orderWay) ;
}
