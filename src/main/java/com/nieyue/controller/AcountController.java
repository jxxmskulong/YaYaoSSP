...
public class AcountController {
	...
	@ApiImplicitParams({
	  @ApiImplicitParam(name="acountId",value="账户ID",dataType="int", paramType = "query",example="1000"),
	  @ApiImplicitParam(name="spreadId",value="推广ID",dataType="int", paramType = "query"),
	  ...
	  @ApiImplicitParam(name="minScale",value="最大合伙人收益比例",dataType="double", paramType = "query"),
	  @ApiImplicitParam(name="maxScale",value="最大合伙人收益比例",dataType="double", paramType = "query"),
	  @ApiImplicitParam(name="masterId",value="师傅ID",dataType="int", paramType = "query"),
	  ...
	  @ApiImplicitParam(name="orderName",value="排序字段",dataType="string", paramType = "query",defaultValue="acount_id"),
	...
	public @ResponseBody StateResult updateAcount(
		@ModelAttribute Acount acount,
			HttpSession session)  {
		//账户已经存在
	 ...
	 * @return
	 */
	@ApiOperation(value = "账户个人信息", notes = "账户个人信息")
	 ...
	 * @return
	 */
	@ApiOperation(value = "账户修改真实姓名、手机号、微信号、支付宝账号", notes = "账户修改真实姓名、手机号、微信号、支付宝账号")
	@ApiImplicitParams({
		  @ApiImplicitParam(name="acountId",value="账户ID",dataType="int", paramType = "query",required=true),
		  @ApiImplicitParam(name="phone",value="手机号",dataType="string", paramType = "query"),
		  @ApiImplicitParam(name="wechat",value="微信号",dataType="string", paramType = "query",required=true),
		  @ApiImplicitParam(name="realname",value="真实姓名",dataType="string", paramType = "query",required=true),
		  @ApiImplicitParam(name="alipay",value="支付宝账号",dataType="string", paramType = "query",required=true)
		  })
	...
	@ApiImplicitParams({
		  @ApiImplicitParam(name="adminName",value="手机号/电子邮箱",dataType="string", paramType = "query",required=true),
		  @ApiImplicitParam(name="templateCode",value="模板 默认1注册，2修改密码",dataType="int", paramType = "query")
		  })
...
//		}
	...
	@ApiImplicitParams({
		  @ApiImplicitParam(name="wxinfo",value="微信登陆返回信息json字符串",dataType="string", paramType = "query",required=true),
		  @ApiImplicitParam(name="appVersion",value="app版本或浏览器版本",dataType="string", paramType = "query"),
		  @ApiImplicitParam(name="spreadId",value="推广ID",dataType="int", paramType = "query")
		  })
